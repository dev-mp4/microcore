...
The firmware is loaded and executed from 0x0, the default memory size is 32 KB, but you can modify this in Memory struct but changing value of `MEM_SIZE` constexpr, note that this constant represents size in bytes.